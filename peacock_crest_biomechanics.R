...
segments(x0=feath$rachis_length_cm, y0=c(feath$f1_Hz+feath$SE_f1_Hz), y1=c(feath$f1_Hz-feath$SE_f1_Hz), col=1, lwd=0.3)
axis(1, at=c(4, 8, 12))
axis(2, at=c(10,20,30,40))
points(c(28.05, 26.3) ~ c(5.3, 5.4), pch=6, col='blue')
segments(x0=c(5.3, 5.4), y0=c(28.0, 25.9), y1=c(28.1, 26.6), lwd=0.3)
